...
<head>
    ...
    <style>
        ...
        .btn-cancel {
            background-color: #918c8cff;       /* Gris clair */
            color: #fff;                  /* Rouge doux */
 ...
 .btn-cancel:hover {
    ...
    color: white;
        ...
        .alert-warning {
            color: #f0ad4e;
            background-color: #f5f1e1ff;
            border-color: #e8e4d2ff;
        }
        .alert-success {
            color: #3c763d;
...
try {
    ...
    <a href='mettre_en_attente_demandes.php?id=" . $row["id"] . "' class='btn pending-btn' onclick=\"return confirm('Voulez-vous mettre cette demande en attente ?')\">
        <i class='fa-solid fa-clock'></i> Attente
    </a>
  
    <a href='Annuler_les_demandes.php?id=" . $row["id"] . "' class='btn btn-cancel' onclick=\"return confirm('Voulez-vous annuler cette demande ?')\">
